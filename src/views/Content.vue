<template>
  ...
  >
    ...
    <!-- Content -->
    <div
      class="mt-2 relative z-10 flex flex-col items-center justify-start text-white text-center px-6 pt-10 pb-20 overflow-y-scroll h-screen"
    >
      <!-- Couple Names -->
      <div class="flex items-center justify-center gap-4 md:gap-8 mt-[-50px]">
        <div class="text-right">
        </div>
        <img src="/src/assets/love1.png" alt="" class="w-55 h-35 md:w-22 md:h-22"/>
        <div class="text-left">
        </div>
      </div>
      <section class>
        ...
        >
          ...
          <div class="text-center">
            ...
            <div class="text-2xl md:text-5xl mt-4 md:mt-10 childs">យៀង ស្រីនិច្ច</div>
          </div>
        </div>
        <div class="text-yellow-600 text-2xl md:text-3xl font-khmer-kh mt-30 main-yellow-3d1">
              សូមគោរពអញ្ជើញ
        </div>
        <div  
        ...
        <div class="text-yellow-600 text-2xl md:text-3xl font-khmer-kh mt-20 main-yellow-3d1">
          ដែលនឹងប្រព្រឹត្តទៅ
        </div>
        <div class="md:text-5xl mt-4 md:mt-20 text-yellow-3d3">
        ...
        <div class="text-yellow-600 text-xl md:text-3xl font-khmer-kh mt-10 text-yellow-3d3">
